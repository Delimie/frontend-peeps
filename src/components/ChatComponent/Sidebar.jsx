  ...
  return (
    <div className="w-1/4 h-[80vh] flex">
      <div className="flex flex-col items-end pt-20 gap-5">
        <div className="h-[5vh] w-[5vw] bg-[#F3B562] rounded-l-4xl">สร้างกลุ่ม</div>
        <div className="h-[5vh] w-[5vw] bg-[#F3B562] rounded-l-4xl">ชื่อกลุ่ม</div>
        <div className="h-[5vh] w-[5vw] bg-[#F3B562] rounded-l-4xl">ชื่อกลุ่ม</div>
        <div className="h-[5vh] w-[5vw] bg-[#F06060] rounded-l-4xl">ชื่อกลุ่ม</div>
        <div className="h-[5vh] w-[5vw] bg-[#F3B562] rounded-l-4xl">ชื่อกลุ่ม</div>
      </div>
      <div className="bg-white w-full h-full rounded-l-3xl pt-7 relative">
        ...
        <div className="mt-5 space-y-2">
          ...
          <div className="flex items-end">Leave group</div>
        </div>
        ...
        {isCreateModalOpen && (
          <div className="fixed inset-0 bg-[#5C4B51]/50 flex items-center justify-center z-50">
            <div className="bg-white w-96 p-6 rounded-xl shadow-lg relative">
              ...
              <h2 className="text-lg font-semibold mb-4 text-center">Create New Room</h2>
              <input
                type="text"
                value={newRoomName}
          ...
          <div className="fixed inset-0 bg-[#5C4B51]/50 flex items-center justify-center z-50">
            <div className="bg-white w-96 p-6 rounded-xl shadow-lg relative">
              ...
              <h2 className="text-lg font-semibold mb-4 text-center">
                ...
                <span className="text-[#F06060] font-bold">{rooms[roomToDelete]}</span>
                ?
              </h2>
              <div className="flex justify-end gap-3">
                <button
