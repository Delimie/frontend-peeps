  ...
  return (
    <div className="h-screen w-full bg-[#F2EBBF] flex gap-10 justify-center pt-20 pb-20">
      ...
      <div className="h-6/7 w-2/5 flex flex-col justify-between">
        ...
        {/* บอร์ดกระปุกออมสิน */}
        <div className="bg-white h-7/15 w-full min-w-[600px] rounded-4xl shadow-[5px_5px_5px_1px_rgba(0,_0,_0,_0.1)] overflow-y-auto">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-10 px-10 pb-8 justify-around">
              ...
              <div className="flex flex-col items-center">
                <div className="h-25 w-25 bg-[#D9D9D9] rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition">
